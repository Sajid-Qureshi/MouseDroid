...
import com.sajid.mousedroid.commands.Commands;
...
public void onKey(int primaryCode, int[] keyCodes) {
	...
	default:
		((MouseDroidApplication) touchPadActivity.getApplicationContext()).getClient().sendCommandKeyAsync(Commands.COMMAND_TYPE_KEY_PRESSED_RELEASED, primaryCode);
		break;
	}
